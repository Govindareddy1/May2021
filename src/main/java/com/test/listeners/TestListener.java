...
public class TestListener implements ITestListener {
	...
	//	ITestContext context = result.getTestContext();
		...
		try 
		{
			...
			System.out.println("Target File location - " + targetFile.getAbsolutePath().toString());
		...
		//	ExtentTestManager.getTest().fail("Details", MediaEntityBuilder.createScreenCaptureFromPath(Paths.get("").toAbsolutePath().toString() + "/screenshotFolder/screenshot.png").build());
		}
		catch (IOException e) 
		{
